...
class Block(nn.Module):
    def __init__(self,nChannels=128,channel_rate=32,drop_rate=0.0, lnum = 1):
...
class Generator(nn.Module):
    def __init__(self,nChannels=128,channel_rate=32,drop_rate=0.0,dilation=1):
        ...
        # Dense Block
        self.block1 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 1)
        self.block2 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 2)
        self.block3 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 3)
        self.block4 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 4)
        self.block5 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 5)
        self.block6 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 6)
        self.block7 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 7)
        self.block8 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 8)
        self.block9 = Block(self.nChannels,self.channel_rate,self.drop_rate,lnum = 9)
        self.block10 = Block(self.nChannels,self.channel_rate,self.drop_rate, lnum = 10)
