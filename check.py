...
for filename in os.listdir(dir_path):
    ...
    patch_size = (256, 256)
    sharp_patch = left_img[height//2-patch_size[0]//2:height//2+patch_size[0]//2, width_cutoff//2-patch_size[1]//2:width_cutoff//2+patch_size[1]//2]
    blur_patch = right_img[height//2-patch_size[0]//2:height//2+patch_size[0]//2, width_cutoff//2-patch_size[1]//2:width_cutoff//2+patch_size[1]//2]
